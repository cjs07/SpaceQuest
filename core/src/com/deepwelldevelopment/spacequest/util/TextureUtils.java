...
public class TextureUtils {
    public static Vector2[] calculateUVMapping(String regionName) {
        ...
        TextureAtlas.AtlasRegion region =
                SpaceQuest.getSpaceQuest().getTextureAtlas().findRegion(regionName);
    ...
    public static Vector2[] calculateUVMapping(String regionName, int index) {
        Vector2[] UVList = new Vector2[4];
        TextureAtlas.AtlasRegion region = SpaceQuest
                .getSpaceQuest().getTextureAtlas().findRegion(regionName, index);
