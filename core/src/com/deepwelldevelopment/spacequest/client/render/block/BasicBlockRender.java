...
public class BasicBlockRender implements IBlockRender {

    static final float SIZE = 1f;
    private final static ArrayMap<Color, float[]> lightCache = new ArrayMap<>();
    //normals, these never change
    ...
    protected void addFront(FloatArray vertices, ShortArray indicies) {
        ...
        vertices.addAll(
                points[0].x, points[0].y, points[0].z, texCoords[0].x, texCoords[0].y,
                breakCoords[0].x, breakCoords[0].y, frontNormal[0], frontNormal[1],
                frontNormal[2], lightFloat4[0], lightFloat4[1], lightFloat4[2], lightFloat4[3],
                points[1].x, points[1].y, points[1].z, texCoords[1].x, texCoords[1].y,
                breakCoords[1].x, breakCoords[1].y, frontNormal[0], frontNormal[1],
                frontNormal[2], lightFloat3[0], lightFloat3[1], lightFloat3[2], lightFloat3[3],
                points[2].x, points[2].y, points[2].z, texCoords[2].x, texCoords[2].y,
                breakCoords[2].x, breakCoords[2].y, frontNormal[0], frontNormal[1],
                frontNormal[2], lightFloat2[0], lightFloat2[1], lightFloat2[2], lightFloat2[3],
                points[3].x, points[3].y, points[3].z, texCoords[3].x, texCoords[3].y,
                breakCoords[3].x, breakCoords[3].y, frontNormal[0], frontNormal[1],
                frontNormal[2], lightFloat[0], lightFloat[1], lightFloat[2], lightFloat[3]
        );

        indicies.addAll((short) (vertexOffset), (short) (1 + vertexOffset),
                (short) (2 + vertexOffset), (short) (2 +
                        vertexOffset), (short) (3 + vertexOffset), (short) (vertexOffset)
        );
    }
    ...
    protected void addBack(FloatArray vertices, ShortArray indicies) {
        int vertexOffset = vertices.size / 14;
        vertices.addAll(
                points[4].x, points[4].y, points[4].z, texCoords[0].x, texCoords[0].y,
                breakCoords[0].x, breakCoords[0].y, backNormal[0], backNormal[1],
                backNormal[2], lightFloat4[0], lightFloat4[1], lightFloat4[2], lightFloat4[3],
                points[5].x, points[5].y, points[5].z, texCoords[1].x, texCoords[1].y,
                breakCoords[1].x, breakCoords[1].y, backNormal[0], backNormal[1],
                backNormal[2], lightFloat3[0], lightFloat3[1], lightFloat3[2], lightFloat3[3],
                points[6].x, points[6].y, points[6].z, texCoords[2].x, texCoords[2].y,
                breakCoords[2].x, breakCoords[2].y, backNormal[0], backNormal[1],
                backNormal[2], lightFloat2[0], lightFloat2[1], lightFloat2[2], lightFloat2[3],
                points[7].x, points[7].y, points[7].z, texCoords[3].x, texCoords[3].y,
                breakCoords[3].x, breakCoords[3].y, backNormal[0], backNormal[1],
    ...
    protected void addRight(FloatArray vertices, ShortArray indicies) {
        int vertexOffset = vertices.size / 14;
        vertices.addAll(
                points[1].x, points[1].y, points[1].z, texCoords[0].x, texCoords[0].y,
                breakCoords[0].x, breakCoords[0].y, rightNormal[0], rightNormal[1],
                rightNormal[2], lightFloat4[0], lightFloat4[1], lightFloat4[2], lightFloat4[3],
                points[4].x, points[4].y, points[4].z, texCoords[1].x, texCoords[1].y,
                breakCoords[1].x, breakCoords[1].y, rightNormal[0], rightNormal[1],
                rightNormal[2], lightFloat3[0], lightFloat3[1], lightFloat3[2], lightFloat3[3],
                points[7].x, points[7].y, points[7].z, texCoords[2].x, texCoords[2].y,
                breakCoords[2].x, breakCoords[2].y, rightNormal[0], rightNormal[1],
                rightNormal[2], lightFloat2[0], lightFloat2[1], lightFloat2[2], lightFloat2[3],
                points[2].x, points[2].y, points[2].z, texCoords[3].x, texCoords[3].y,
                breakCoords[3].x, breakCoords[3].y, rightNormal[0], rightNormal[1],
    ...
    protected void addLeft(FloatArray vertices, ShortArray indicies) {
        int vertexOffset = vertices.size / 14;
        vertices.addAll(
                points[5].x, points[5].y, points[5].z, texCoords[0].x, texCoords[0].y,
                breakCoords[0].x, breakCoords[0].y, leftNormal[0], leftNormal[1],
                leftNormal[2], lightFloat4[0], lightFloat4[1], lightFloat4[2], lightFloat4[3],
                points[0].x, points[0].y, points[0].z, texCoords[1].x, texCoords[1].y,
                breakCoords[1].x, breakCoords[1].y, leftNormal[0], leftNormal[1],
                leftNormal[2], lightFloat3[0], lightFloat3[1], lightFloat3[2], lightFloat3[3],
                points[3].x, points[3].y, points[3].z, texCoords[2].x, texCoords[2].y,
                breakCoords[2].x, breakCoords[2].y, leftNormal[0], leftNormal[1],
                leftNormal[2], lightFloat2[0], lightFloat2[1], lightFloat2[2], lightFloat2[3],
                points[6].x, points[6].y, points[6].z, texCoords[3].x, texCoords[3].y,
                breakCoords[3].x, breakCoords[3].y, leftNormal[0], leftNormal[1],
    ...
    protected void addTop(FloatArray vertices, ShortArray indicies) {
        int vertexOffset = vertices.size / 14;
        vertices.addAll(
                points[3].x, points[3].y, points[3].z, texCoords[0].x, texCoords[0].y,
                breakCoords[0].x, breakCoords[0].y, topNormal[0], topNormal[1],
                topNormal[2], lightFloat[0], lightFloat[1], lightFloat[2], lightFloat[3],
                points[2].x, points[2].y, points[2].z, texCoords[1].x, texCoords[1].y,
                breakCoords[1].x, breakCoords[1].y, topNormal[0], topNormal[1],
                topNormal[2], lightFloat2[0], lightFloat2[1], lightFloat2[2], lightFloat2[3],
                points[7].x, points[7].y, points[7].z, texCoords[2].x, texCoords[2].y,
                breakCoords[2].x, breakCoords[2].y, topNormal[0], topNormal[1],
                topNormal[2], lightFloat3[0], lightFloat3[1], lightFloat3[2], lightFloat3[3],
                points[6].x, points[6].y, points[6].z, texCoords[3].x, texCoords[3].y,
                breakCoords[3].x, breakCoords[3].y, topNormal[0], topNormal[1],
    ...
    protected void addBottom(FloatArray vertices, ShortArray indicies) {
        ...
        vertices.addAll(
                points[5].x, points[5].y, points[5].z, texCoords[0].x, texCoords[0].y,
                breakCoords[0].x, breakCoords[0].y, bottomNormal[0], bottomNormal[1],
                bottomNormal[2], lightFloat[0], lightFloat[1], lightFloat[2], lightFloat[3],
                points[4].x, points[4].y, points[4].z, texCoords[1].x, texCoords[1].y,
                breakCoords[1].x, breakCoords[1].y, bottomNormal[0], bottomNormal[1],
                bottomNormal[2], lightFloat2[0], lightFloat2[1], lightFloat2[2], lightFloat2[3],
                points[1].x, points[1].y, points[1].z, texCoords[2].x, texCoords[2].y,
                breakCoords[2].x, breakCoords[2].y, bottomNormal[0], bottomNormal[1],
                bottomNormal[2], lightFloat3[0], lightFloat3[1], lightFloat3[2], lightFloat3[3],
                points[0].x, points[0].y, points[0].z, texCoords[3].x, texCoords[3].y,
                breakCoords[3].x, breakCoords[3].y, bottomNormal[0], bottomNormal[1],
    ...
    protected void setTexCoords(Vector2[] textureUVs) {
        ...
        System.arraycopy(textureUVs, 0, texCoords, 0, 4);
    }
    ...
    protected void setAOLightFront(int x, int y, int z, Chunk chunk, Block block) {
        ...
        if (block.isLightSource()) {
            lightFloat[0] =
                    lightFloat2[0] = lightFloat3[0] = lightFloat4[0] = lightFloatBlock[0];
            lightFloat[1] =
                    lightFloat2[1] = lightFloat3[1] = lightFloat4[1] = lightFloatBlock[1];
            lightFloat[2] =
                    lightFloat2[2] = lightFloat3[2] = lightFloat4[2] = lightFloatBlock[2];
            lightFloat[3] =
                    lightFloat2[3] = lightFloat3[3] = lightFloat4[3] = lightFloatBlock[3];
            return;
        }
        ...
        lightFloat[0] = (above[0] + leftUpper[0] + frontUpperLeft[0] + lightFloatBlock[0]) /
                4; // UpperLeft
        ...
        lightFloat2[0] = (above[0] + +frontUpperRight[0] + rightUpper[0] + lightFloatBlock[0]) /
                4; // UpperRight
        lightFloat2[1] =
                (above[1] + +frontUpperRight[1] + rightUpper[1] + lightFloatBlock[1]) / 4;
        lightFloat2[2] =
                (above[2] + +frontUpperRight[2] + rightUpper[2] + lightFloatBlock[2]) / 4;
        lightFloat2[3] =
                (above[3] + +frontUpperRight[3] + rightUpper[3] + lightFloatBlock[3]) / 4;

        lightFloat3[0] =
                (below[0] + +right[0] + frontRight[0] + lightFloatBlock[0]) / 4; // BottomRight
        ...
        lightFloat4[0] =
                (below[0] + +left[0] + frontLeft[0] + lightFloatBlock[0]) / 4; // BottomLeft
    ...
    protected void setAOLightTop(int x, int y, int z, Chunk chunk, Block block) {
        ...
        lightFloat2[0] =
                (north[0] + northEast[0] + east[0] + above[0] + lightFloatBlock[0]) / 5;
        lightFloat2[1] =
                (north[1] + northEast[1] + east[1] + above[1] + lightFloatBlock[1]) / 5;
        lightFloat2[2] =
                (north[2] + northEast[2] + east[2] + above[2] + lightFloatBlock[2]) / 5;
        lightFloat2[3] =
                (north[3] + northEast[3] + east[3] + above[3] + lightFloatBlock[3]) / 5;

        lightFloat4[0] =
                (south[0] + southWest[0] + west[0] + above[0] + lightFloatBlock[0]) / 5;
        lightFloat4[1] =
                (south[1] + southWest[1] + west[1] + above[1] + lightFloatBlock[1]) / 5;
        lightFloat4[2] =
                (south[2] + southWest[2] + west[2] + above[2] + lightFloatBlock[2]) / 5;
        lightFloat4[3] =
                (south[3] + southWest[3] + west[3] + above[3] + lightFloatBlock[3]) / 5;

        lightFloat3[0] =
                (south[0] + southEast[0] + east[0] + above[0] + lightFloatBlock[0]) / 5;
        lightFloat3[1] =
                (south[1] + southEast[1] + east[1] + above[1] + lightFloatBlock[1]) / 5;
        lightFloat3[2] =
                (south[2] + southEast[2] + east[2] + above[2] + lightFloatBlock[2]) / 5;
        lightFloat3[3] =
                (south[3] + southEast[3] + east[3] + above[3] + lightFloatBlock[3]) / 5;
    }
    ...
    protected void setAOLightBottom(int x, int y, int z, Chunk chunk, Block block) {
        ...
        lightFloat2[0] =
                (north[0] + northEast[0] + east[0] + below[0] + lightFloatBlock[0]) / 5;
        lightFloat2[1] =
                (north[1] + northEast[1] + east[1] + below[1] + lightFloatBlock[1]) / 5;
        lightFloat2[2] =
                (north[2] + northEast[2] + east[2] + below[2] + lightFloatBlock[2]) / 5;
        lightFloat2[3] =
                (north[3] + northEast[3] + east[3] + below[3] + lightFloatBlock[3]) / 5;

        lightFloat4[0] =
                (south[0] + southWest[0] + west[0] + below[0] + lightFloatBlock[0]) / 5;
        lightFloat4[1] =
                (south[1] + southWest[1] + west[1] + below[1] + lightFloatBlock[1]) / 5;
        lightFloat4[2] =
                (south[2] + southWest[2] + west[2] + below[2] + lightFloatBlock[2]) / 5;
        lightFloat4[3] =
                (south[3] + southWest[3] + west[3] + below[3] + lightFloatBlock[3]) / 5;

        lightFloat3[0] =
                (south[0] + southEast[0] + east[0] + below[0] + lightFloatBlock[0]) / 5;
        lightFloat3[1] =
                (south[1] + southEast[1] + east[1] + below[1] + lightFloatBlock[1]) / 5;
        lightFloat3[2] =
                (south[2] + southEast[2] + east[2] + below[2] + lightFloatBlock[2]) / 5;
        lightFloat3[3] =
                (south[3] + southEast[3] + east[3] + below[3] + lightFloatBlock[3]) / 5;
    }

    protected float[] getBlockLight(int x, int y, int z, int x1, int y1, int z1, Chunk chunk,
            Block block) {
        byte blockLight;
        float[] finalLight;
        if (block.isLightSource()) {
