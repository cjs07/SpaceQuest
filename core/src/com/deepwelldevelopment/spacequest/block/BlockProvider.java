...
//    public final static Block sandStone = new StoneBlock((byte) 12, "textures/sandstone");
    ...
    public static final Block light = new Block((byte) 3, "glass");
    public static final Block glass = new Block((byte) 4, "glass");
    ...
    public static final Block straws = new Block((byte) 8, "leaves");
    public static final Block flower = new Block((byte) 9, "flower");
    public static final Block water = new Block((byte) 10, "water");
